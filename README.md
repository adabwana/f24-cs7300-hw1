...
## **[Please click HERE to view the workbook](https://adabwana.github.io/f24-cs7300-hw1/).**
...
2. In DevPod, go to `Workspaces`, click `+ Create`, in the `Git Repo` field, enter `https://github.com/yourgithubusername/f24-cs7300-hw1`, ensure `Docker` is selected in `Provider`, Name your workspace (e.g. `f24-cs7300-hw1`), and click the `Create Workspace` button. The project will open in your browser using the provided `.devcontainer` configuration.
...
3. In the VSCode terminal, clone the repository to `Documents/projects`, for example:
   ...
   git clone https://github.com/adabwana/f24-cs7300-hw1.git
   cd f24-cs7300-hw1
   code .
   ```
